...
#ifndef MODULES_TASK_2_KUMBRASEV_M_CONJUGATE_GRADIENT_OMP_COR_CONJUGATE_GRADIENT_H_
#define MODULES_TASK_2_KUMBRASEV_M_CONJUGATE_GRADIENT_OMP_COR_CONJUGATE_GRADIENT_H_
...
std::vector<double> ConjugateGradient(const std::vector<std::vector<double>> &M, const std::vector<double> &B, int proc);

#endif  // MODULES_TASK_2_KUMBRASEV_M_CONJUGATE_GRADIENT_OMP_COR_CONJUGATE_GRADIENT_H_
